...
// let data =  'hello hello hello hello hellohello hello hello hello hello hello hello  hello hello hello';
...
console.log('file deleted');// File system module
